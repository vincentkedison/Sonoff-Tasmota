...
// -- Project -------------------------------------
#define PROJECT                "lasmota"         // PROJECT is used as the default topic delimiter
...
#define FRIENDLY_NAME          "Lasmota"         // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#define COLOR_BUTTON                "#1e88e5"    // [WebColor11] Button color - Blueish
#define COLOR_BUTTON_HOVER          "#1565c0"    // [WebColor12] Button color when hovered over - Darker blueish
...
// -- Location ------------------------------------
#define LATITUDE               -3.5265737         // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              114.9084385          // [Longitude] Your location to be used with sunrise and sunset
